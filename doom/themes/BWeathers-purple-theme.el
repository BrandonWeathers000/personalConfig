;;; Package -- BWeathers-purple-theme
;;; Commentary:
        ;;; This is my custom theme based off of the movie Tron: Legacy

;;; Code:
(deftheme BWeathers-purple)
(let ((class '((class color) (min-colors 89)))
      ;; Color definitions
      (fg1       "#FFFFFF")
      (fg2       "#FFFFFF")
      (fg3       "#FFFFFF")
      (fg4       "#D2C4ED") ; Outline colors
      (fg6       "#5D5D5D")
      (bg1       "#000000")
      (bg2       "#000000")
      (bg3       "#292929")
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:bold t :foreground ,fg4))))
   `(org-level-2 ((,class (:bold t :foreground ,fg4))))
...
(provide-theme 'BWeathers-purple)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; BWeathers-purple-theme.el ends here
